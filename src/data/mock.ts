...
export const SERVICES: Service[] = [
  { id: 'lawyer', name: 'Lawyer / Legal Services', shortName: 'Lawyer', description: 'Consult verified lawyers for property, civil, criminal, family and corporate cases.', fee: 'From PKR 2,000', duration: '1-3 days', icon: 'Scale', image: '/images/svc-lawyer.jpg', category: 'legal' },
  { id: 'estamp', name: 'E-Stamp', shortName: 'E-Stamp', description: 'Apply for e-stamp papers with live selfie verification.', fee: 'From PKR 500', duration: '3-5 days', icon: 'Stamp', image: '/images/svc-estamp.jpg', category: 'legal' },
  { id: 'land-registration', name: 'Land Registration', shortName: 'Registration', description: 'Register your land with full documentation support.', fee: 'From PKR 5,000', duration: '7-14 days', icon: 'FileText', image: '/images/svc-land-registration.jpg', category: 'legal' },
  { id: 'intiqal', name: 'Intiqal (Mutation)', shortName: 'Intiqal', description: 'Transfer property ownership through mutation records.', fee: 'From PKR 3,000', duration: '7-10 days', icon: 'ArrowLeftRight', image: '/images/svc-intiqal.jpg', category: 'legal' },
  { id: 'kiraya-nama', name: 'Kiraya Nama (Rent Agreement)', shortName: 'Kiraya Nama', description: 'Draft and register rent agreements with legal validity.', fee: 'From PKR 1,500', duration: '1-2 days', icon: 'FileSignature', image: '/images/svc-kiraya-nama.jpg', category: 'legal' },
  ...
  { id: 'gas-meter', name: 'Gas Meter Transfer', shortName: 'Gas Meter', description: 'Transfer gas meter connection to new owner.', fee: 'From PKR 1,000', duration: '3-5 days', icon: 'Flame', image: '/images/svc-gas-meter.jpg', category: 'utility' },
  { id: 'electricity-meter', name: 'Electricity Meter Transfer', shortName: 'Electricity', description: 'Transfer electricity meter to new owner name.', fee: 'From PKR 1,000', duration: '3-5 days', icon: 'Zap', image: '/images/svc-electricity-meter.jpg', category: 'utility' },
  { id: 'water-meter', name: 'Water Meter Transfer', shortName: 'Water', description: 'Transfer water connection and meter ownership.', fee: 'From PKR 800', duration: '2-4 days', icon: 'Droplets', image: '/images/svc-water-meter.jpg', category: 'utility' },
  ...
  { id: 'valuation', name: 'Property Valuation', shortName: 'Valuation', description: 'Get certified property valuation reports.', fee: 'From PKR 3,000', duration: '2-3 days', icon: 'Calculator', image: '/images/svc-valuation.jpg', category: 'valuation' },
  { id: 'attestation', name: 'Document Attestation', shortName: 'Attestation', description: 'Attest your legal documents officially.', fee: 'From PKR 500', duration: '1-2 days', icon: 'BadgeCheck', image: '/images/svc-attestation.jpg', category: 'legal' },
];
