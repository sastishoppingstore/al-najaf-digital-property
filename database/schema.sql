...
-- ============================================================
-- 
-- Admin Log entries (demo data) would be inserted here for admin actions
INSERT INTO admin_logs (user_id, action, entity, entity_id, ip_address, user_agent, created_at) VALUES
(6, 'User logged in', 'users', 6, '192.168.1.1', 'Mozilla/5.0', '2024-03-01 08:00:00'),
(6, 'Approved property', 'properties', 1, '192.168.1.1', 'Mozilla/5.0', '2024-03-01 14:00:00'),
(6, 'Approved E-Stamp application', 'estamp', 1, '192.168.1.1', 'Mozilla/5.0', '2024-03-03 14:00:00'),
(6, 'Completed E-Stamp application', 'estamp', 1, '192.168.1.1', 'Mozilla/5.0', '2024-03-05 16:00:00'),
(6, 'Approved E-Stamp application', 'estamp', 2, '192.168.1.1', 'Mozilla/5.0', '2024-03-12 15:00:00'),
(6, 'Completed E-Stamp application', 'estamp', 2, '192.168.1.1', 'Mozilla/5.0', '2024-03-14 17:00:00');

-- ============================================================
-- END OF SCHEMA AND SAMPLE DATA
-- ============================================================

-- Demo login: user/Test@1234, admin/Test@1234
